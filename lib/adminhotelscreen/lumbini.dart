...
class HotelScreenLumbini1 extends StatefulWidget {
  final Hotellumbini lumbinihotel;
  HotelScreenLumbini1({this.lumbinihotel});
  @override
  _HotelScreenLumbini1State createState() => _HotelScreenLumbini1State();
}

final FirebaseAuth auth = FirebaseAuth.instance;

class _HotelScreenLumbini1State extends State<HotelScreenLumbini1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: new FloatingActionButton(
          ...
          onPressed: () {
            Firestore.instance
                .collection("HotelLumbini")
                .document(widget.lumbinihotel.name)
                .delete();
          }),
    );
  }

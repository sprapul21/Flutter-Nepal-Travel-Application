...
class AdminPannelothers extends StatefulWidget {
  const AdminPannelothers({Key key}) : super(key: key);

  @override
  _AdminPannelothersState createState() => _AdminPannelothersState();
}

class _AdminPannelothersState extends State<AdminPannelothers> {
      ...
      body: Form(
        ...
        child: Column(
          children: [
            Center(
              child: Container(
                child: Text('Add Hotel of your desired loaction'),
              ),
            ),
            Container(
            ...
            Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                    border: InputBorder.none,
                    icon: Icon(Icons.person),
                    hintText: 'Please Enter an Hotel Image Url',
                    hintStyle: TextStyle(color: Colors.grey, fontSize: 12.0)),
              ),
            ),
            Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                    border: InputBorder.none,
                    icon: Icon(Icons.person),
                    hintText: 'Please Enter Enter an Hotel Description',
                    hintStyle: TextStyle(color: Colors.grey, fontSize: 12.0)),
              ),
            ),
            Container(
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState.validate()) {
                      dynamic result =
                          _auth.saveOthersAdmin(name, desc, image, price);
                      if (result == null) {
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Hotelothersplaces1()));
              },
              child: Container(
                height: 70,
                width: 150,

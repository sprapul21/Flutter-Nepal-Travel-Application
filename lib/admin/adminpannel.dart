          ...
          Form(
            ...
            child: Column(
              children: [
                Center(
                  child: Container(
                    child: Text('Bhaktapur Add Hotel'),
                  ),
                ),
                Container(
                  ...
                  child: TextFormField(
                    validator: (val) =>
                        val.isEmpty ? 'Enter a Hotel name' : null,
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () {
                        if (_formKey.currentState.validate()) {
                          dynamic result = _auth.saveBhaktapurAdmin(
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => Hotelbhaktapurplaces1()));
            },
            child: Container(
              height: 70,
              width: 150,

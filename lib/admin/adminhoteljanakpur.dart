...
class AdminPanneljanakpur extends StatefulWidget {
  const AdminPanneljanakpur({Key key}) : super(key: key);

  @override
  _AdminPanneljanakpurState createState() => _AdminPanneljanakpurState();
}

class _AdminPanneljanakpurState extends State<AdminPanneljanakpur> {
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState.validate()) {
                      dynamic result =
                          _auth.saveJanakpurAdmin(name, desc, image, price);
                      if (result == null) {
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Hoteljanakpurplaces1()));
              },
              child: Container(
                height: 70,
                width: 150,

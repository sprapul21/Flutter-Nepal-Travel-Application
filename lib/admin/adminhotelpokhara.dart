...
class AdminPannelpokhara extends StatefulWidget {
  const AdminPannelpokhara({Key key}) : super(key: key);

  @override
  _AdminPannelpokharaState createState() => _AdminPannelpokharaState();
}

class _AdminPannelpokharaState extends State<AdminPannelpokhara> {
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState.validate()) {
                      dynamic result =
                          _auth.savePokharaAdmin(name, desc, image, price);
                      if (result == null) {
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Hotelpokharaplaces1()));
              },
              child: Container(
                height: 70,
                width: 150,

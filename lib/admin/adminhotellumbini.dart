...
class AdminPannellumbini extends StatefulWidget {
  const AdminPannellumbini({Key key}) : super(key: key);

  @override
  _AdminPannellumbiniState createState() => _AdminPannellumbiniState();
}

class _AdminPannellumbiniState extends State<AdminPannellumbini> {
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState.validate()) {
                      dynamic result =
                          _auth.saveLumbiniAdmin(name, desc, image, price);
                      if (result == null) {
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Hotellumbiniplaces1()));
              },
              child: Container(
                height: 70,
                width: 150,

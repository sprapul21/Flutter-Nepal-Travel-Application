...
class AdminPannelLalitpur extends StatefulWidget {
  const AdminPannelLalitpur({Key key}) : super(key: key);

  @override
  _AdminPannelLalitpurState createState() => _AdminPannelLalitpurState();
}

class _AdminPannelLalitpurState extends State<AdminPannelLalitpur> {
            ...
            Container(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                    border: InputBorder.none,
                    icon: Icon(Icons.person),
                    hintText: 'Please Enter an Hotel Price',
                    hintStyle: TextStyle(color: Colors.grey, fontSize: 12.0)),
              ),
            ),
            Center(
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    if (_formKey.currentState.validate()) {
                      dynamic result =
                          _auth.saveLalitpurAdmin(name, desc, image, price);
                      if (result == null) {
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Hotellalitpurplaces1()));
              },
              child: Container(
                height: 70,
                width: 150,

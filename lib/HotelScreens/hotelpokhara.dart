...
class HotelScreenPokhara extends StatefulWidget {
  final Hotelpokhara pokharahotel;
  HotelScreenPokhara({this.pokharahotel});
  @override
  _HotelScreenPokharaState createState() => _HotelScreenPokharaState();
}

final FirebaseAuth auth = FirebaseAuth.instance;

class _HotelScreenPokharaState extends State<HotelScreenPokhara> {
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(widget.pokharahotel.image),
                          fit: BoxFit.cover),
                    ),
                  ),
                  Center(
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              child: Text(widget.pokharahotel.name,
                                  style: GoogleFonts.lato(
                                      fontSize: 20,
                            ...
                            Container(
                              child: Text("Rs. ${widget.pokharahotel.price}",
                                  style: GoogleFonts.lato(
                                      fontSize: 20,
                                      fontWeight: FontWeight.w900,
                                      color: Colors.red)),
                    ...
                    child: InkWell(
                      onTap: () {
                        if (_formKey.currentState.validate()) {
                          dynamic result = _auth.pokharabookings(
                            name,
                            email,
                            phoneno,
                            _selectedrooms,

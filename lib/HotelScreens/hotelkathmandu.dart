...
class HotelScreenKathmandu extends StatefulWidget {
  final Hotelkathmandu kathmanduhotel;
  HotelScreenKathmandu({this.kathmanduhotel});
  @override
  _HotelScreenKathmanduState createState() => _HotelScreenKathmanduState();
}

final FirebaseAuth auth = FirebaseAuth.instance;

class _HotelScreenKathmanduState extends State<HotelScreenKathmandu> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Stack(children: [
          ListView(
            children: [
              Image.network(widget.kathmanduhotel.image),
              Padding(
              ...
              Padding(
                ...
                child: Text(
                  "Rs." + widget.kathmanduhotel.price + " Per Night",
                  style: GoogleFonts.roboto(
                      textStyle: TextStyle(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(widget.kathmanduhotel.image),
                          fit: BoxFit.cover),
                    ),
                  ),
                  Center(
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              child: Text(widget.kathmanduhotel.name,
                                  style: GoogleFonts.lato(
                                      fontSize: 20,
                            ...
                            Container(
                              child: Text("Rs. ${widget.kathmanduhotel.price}",
                                  style: GoogleFonts.lato(
                                      fontSize: 20,
                                      fontWeight: FontWeight.w900,
                                      color: Colors.red)),
                    ...
                    child: InkWell(
                      onTap: () {
                        if (_formKey.currentState.validate()) {
                          dynamic result = _auth.kathmandubookings(
                            name,
                            email,
                            phoneno,
                            _selectedrooms,

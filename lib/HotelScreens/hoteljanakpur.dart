...
class HotelScreenJanakpur extends StatefulWidget {
  final Hoteljanakpur janakpurhotel;
  HotelScreenJanakpur({this.janakpurhotel});
  @override
  _HotelScreenJanakpurState createState() => _HotelScreenJanakpurState();
}

final FirebaseAuth auth = FirebaseAuth.instance;

class _HotelScreenJanakpurState extends State<HotelScreenJanakpur> {
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(widget.janakpurhotel.image),
                          fit: BoxFit.cover),
                    ),
                  ),
                  Center(
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              child: Text(widget.janakpurhotel.name,
                                  style: GoogleFonts.lato(
                                      fontSize: 20,
                            ...
                            Container(
                              child: Text("Rs. ${widget.janakpurhotel.price}",
                                  style: GoogleFonts.lato(
                                      fontSize: 20,
                                      fontWeight: FontWeight.w900,
                                      color: Colors.red)),
                    ...
                    child: InkWell(
                      onTap: () {
                        if (_formKey.currentState.validate()) {
                          dynamic result = _auth.janakpurbookings(
                            name,
                            email,
                            phoneno,
                            _selectedrooms,

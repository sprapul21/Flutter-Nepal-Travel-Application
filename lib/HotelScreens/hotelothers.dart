...
class HotelScreenOthers extends StatefulWidget {
  final Hotelothers othershotel;
  HotelScreenOthers({this.othershotel});
  @override
  _HotelScreenOthersState createState() => _HotelScreenOthersState();
}

final FirebaseAuth auth = FirebaseAuth.instance;

class _HotelScreenOthersState extends State<HotelScreenOthers> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Stack(children: [
          ListView(
            children: [
              Image.network(widget.othershotel.image),
              Padding(
              ...
              Padding(
                ...
                child: Text(
                  "Rs." + widget.othershotel.price + " Per Night",
                  style: GoogleFonts.roboto(
                      textStyle: TextStyle(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(widget.othershotel.image),
                          fit: BoxFit.cover),
                    ),
                  ),
                  Center(
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              child: Text(widget.othershotel.name,
                                  style: GoogleFonts.lato(
                                      fontSize: 20,
                            ...
                            Container(
                              child: Text("Rs. ${widget.othershotel.price}",
                                  style: GoogleFonts.lato(
                                      fontSize: 20,
                                      fontWeight: FontWeight.w900,
                                      color: Colors.red)),
                    ...
                    child: InkWell(
                      onTap: () {
                        if (_formKey.currentState.validate()) {
                          dynamic result = _auth.othersplacebookings(
                            name,
                            email,
                            phoneno,
                            _selectedrooms,

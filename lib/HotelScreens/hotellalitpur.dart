...
class HotelScreenLalitpur extends StatefulWidget {
  final Hotellalitpur lalitpurhotel;
  HotelScreenLalitpur({this.lalitpurhotel});
  @override
  _HotelScreenLalitpurState createState() => _HotelScreenLalitpurState();
}

final FirebaseAuth auth = FirebaseAuth.instance;

class _HotelScreenLalitpurState extends State<HotelScreenLalitpur> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Stack(children: [
          ListView(
            children: [
              Image.network(widget.lalitpurhotel.image),
              Padding(
              ...
              Padding(
                ...
                child: Text(
                  "Rs." + widget.lalitpurhotel.price + " Per Night",
                  style: GoogleFonts.roboto(
                      textStyle: TextStyle(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(widget.lalitpurhotel.image),
                          fit: BoxFit.cover),
                    ),
                  ),
                  Center(
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              child: Text(widget.lalitpurhotel.name,
                                  style: GoogleFonts.lato(
                                      fontSize: 20,
                            ...
                            Container(
                              child: Text("Rs. ${widget.lalitpurhotel.price}",
                                  style: GoogleFonts.lato(
                                      fontSize: 20,
                                      fontWeight: FontWeight.w900,
                                      color: Colors.red)),
                    ...
                    child: InkWell(
                      onTap: () {
                        if (_formKey.currentState.validate()) {
                          dynamic result = _auth.lalitpurbookings(
                            name,
                            email,
                            phoneno,
                            _selectedrooms,

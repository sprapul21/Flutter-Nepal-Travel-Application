...
class HotelScreen extends StatefulWidget {
  ...
  HotelScreen({this.bhaktapurhotel});
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(widget.bhaktapurhotel.image),
                          fit: BoxFit.cover),
                    ),
                  ),
                  Center(
                    child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              child: Text(widget.bhaktapurhotel.name,
                                  style: GoogleFonts.lato(
                                      fontSize: 20,
                            ...
                            Container(
                              child: Text("Rs. ${widget.bhaktapurhotel.price}",
                                  style: GoogleFonts.lato(
                                      fontSize: 20,
                                      fontWeight: FontWeight.w900,
                                      color: Colors.red)),
                    ...
                    child: InkWell(
                      onTap: () {
                        if (_formKey.currentState.validate()) {
                          dynamic result = _auth.bhaktapurbookings(
                            name,
                            email,
                            phoneno,
                            _selectedrooms,
